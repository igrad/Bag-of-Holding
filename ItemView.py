...
class CozyView(ButtonBehavior, RelativeLayout):
    def __init__(self, itemID, **kwargs):
        ...
        IV_ICON = IV_COZY_ICON
        IV_NAME = IV_COZY_NAME
        IV_MISC = IV_COZY_MISC
...
class NormView(ButtonBehavior, RelativeLayout):
    def __init__(self, itemID, **kwargs):
        ...
        IV_ICON = IV_NORM_ICON
        IV_NAME = IV_NORM_NAME
        IV_MISC = IV_NORM_MISC
...
class CardView(ButtonBehavior, RelativeLayout):
    def __init__(self, itemID, **kwargs):
        IV_ICON = IV_CARD_ICON
        IV_NAME = IV_CARD_NAME
        IV_MISC = IV_CARD_MISC
        IV_DESC = IV_CARD_DESC
